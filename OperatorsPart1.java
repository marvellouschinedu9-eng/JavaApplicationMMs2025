...
public class OperatorsPart1{
    public static void main(String[] args){
		...
		int remainder = num1%num2;
         ...
         boolean isGreater = number1 > number2;
		 System.out.print("Is %d > %d? %b%n",number1,number2,isGreater);
		 
		 
         boolean isLessThan = number1 > number2;
		 System.out.print("Is %d < %d? %b%n",number1,number2,islessThan);
		 
		 
         boolean isGreaterThanorEqualTo = number1 >= number2;
		 System.out.print("Is %d >= %d? %b%n",number1,number2,isGreaterThanorEqualTo);
		 
		 
         boolean isLessThanOrEqualTo = number1 <= number2;
		 System.out.print("Is %d <= %d? %b%n",number1,number2,isLessThanOrEqualTo);
		 
		 
         boolean isNotEqualTo = number1 != number2;
		 System.out.print("Is %d != %d? %b%n",number1,number2,isNotEqualTo);
		 
		 
         boolean isEqualTo = number1 == number2;
		 System.out.print("Is %d == %d? %b%n",number1,number2,isEqualTo);
		 
		 
		 
	}
>>>>>>> 3fa5c33377d5f22e6b7a97328c00f3d07c15dc17
}